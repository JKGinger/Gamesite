...
<center>
<div class="header">
    <div class="headder"><h2>SpeedRun level 2</h2></div>
...
<div>
    ...
    <a href="speedrunLvl1.php"><button class="btn btn-primary btn-lg mx-2" id="nextLevel">Previous level</button></a>
</div>
    ...
    <img src="img/spikes.png" style="display: none;">
